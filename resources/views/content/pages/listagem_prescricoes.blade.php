    ...
    <div class="col-md-12">
      <div class="card mb-3">
        <div class="card-header header-elements">
          <h3 class="align-text-bottom-2">Listagem de Prescrições</h3>
          <div class="card-header-elements ms-auto mt-3 mb-1 me-2">
            <a href="/cadastro-prescricao" class="btn btn-primary"><i class="mdi mdi-plus-circle-outline mdi-24px me-2"></i>Adicionar Prescrição</a>
          </div>
        </div>
      </div>
    </div>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center gap-2">
                  <button type="button" class="btn btn-sm btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#detalhar-{{ $prescricao->id }}">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <div class="row">
                          <div class="col-6 mb-3">
                            ...
                            <p class="fw-semibold mb-0">{{ $prescricao->consulta->paciente->nome ?? '-' }}</p>
                          </div>
                          <div class="col-6 mb-3">
                            <p class="text-muted small mb-1">Profissional</p>
                            <p class="fw-semibold mb-0">{{ $prescricao->consulta->profissional->nome ?? '-' }}</p>
                          </div>
                      ...
                      <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#deletar-{{ $prescricao->id }}">
