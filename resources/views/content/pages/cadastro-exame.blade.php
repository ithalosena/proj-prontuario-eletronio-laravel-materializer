      ...
      <div class="card mb-3">
        <div class="card-header header-elements">
          ...
          <div class="card-header-elements ms-auto mt-3 mb-1 me-2">
            <a href="/exames" class="btn btn-default"><i class="mdi mdi-arrow-u-left-bottom mdi-24px me-2"></i>Voltar</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card-body">
      ...
      <form class="browser-default-validation" action="/cadastrar-exame" method="POST">
        ...
        <div class="mt-4">
          ...
          <a href="/exames" class="btn btn-outline-secondary ms-2">Cancelar</a>
        </div>
      </form>
    </div>
  </div>
